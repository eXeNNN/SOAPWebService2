...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements pkg.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/HelloServer/HelloWorldWS";
    ...
    public pkg.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            pkg.HelloWorldImplPortBindingStub _stub = new pkg.HelloWorldImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (pkg.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                pkg.HelloWorldImplPortBindingStub _stub = new pkg.HelloWorldImplPortBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://pkg/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://pkg/", "HelloWorldImplPort"));
        }
